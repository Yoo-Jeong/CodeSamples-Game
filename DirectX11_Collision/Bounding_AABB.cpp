...
_bool CBounding_AABB::Intersect_Ray(const RAY& In_Ray, float* Out_pDistance)
{
...
_vector CBounding_AABB::Get_CurrentPosition()
{
	_vector vResult = XMVectorSetW(XMLoadFloat3(&m_pAABB->Center), 1.f);
	return vResult;
}
